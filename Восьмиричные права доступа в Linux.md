...
Пример: один и тот же символ (цифра, бит) в разных контекстах означает РАЗНЫЕ вещи.
- `0`  в оперативной памяти — это отсутствие электрического заряда, бит со значением "ложь".
- `0` в восьмеричных правах доступа — это отсутствие ВСЕХ разрешений (---). Это не "ничего", это активный ЗАПРЕТ.
      ---
...
---
Понял, что ты запутался! Давай разберем этот вопрос **с самого начала**, по шагам, как будто ты видишь это впервые.
